import{_ as a,c as i,ae as n,o as p}from"./chunks/framework.ilBJtLV6.js";const A=JSON.parse('{"title":"ENV配置说明","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"guide/envConf.md","filePath":"guide/envConf.md","lastUpdated":1738016140000}'),l={name:"guide/envConf.md"};function e(h,s,t,k,d,r){return p(),i("div",null,s[0]||(s[0]=[n(`<h1 id="env配置说明" tabindex="-1">ENV配置说明 <a class="header-anchor" href="#env配置说明" aria-label="Permalink to &quot;ENV配置说明&quot;">​</a></h1><p><strong>注意:改方式仅支持miaospeed v5版本</strong></p><div class="language-dotenv vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dotenv</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># MiaoSpeed Pro 服务端配置的 .env 文件</span></span>
