import{_ as a,c as i,ae as n,o as l}from"./chunks/framework.ilBJtLV6.js";const A=JSON.parse('{"title":"ENV配置说明","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"install/envConf.md","filePath":"install/envConf.md","lastUpdated":1738147623000}'),p={name:"install/envConf.md"};function e(h,s,t,k,r,d){return l(),i("div",null,s[0]||(s[0]=[n(`<h1 id="env配置说明" tabindex="-1">ENV配置说明 <a class="header-anchor" href="#env配置说明" aria-label="Permalink to &quot;ENV配置说明&quot;">​</a></h1><p><strong>注意:该方式仅支持miaospeed v5版本</strong></p><div class="language-dotenv vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dotenv</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># MiaoSpeed Pro 服务端配置的 .env 文件</span></span>
